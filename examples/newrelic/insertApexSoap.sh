...
eventmonitoring dump --type ApexSoap --format json -d --logformat=bunyan --logfile $LOG_FILE --start $YESTERDAY | \
	jq --slurpfile usermap $USER_TMP --arg lasttimestamp $lasttimestamp -f jq_transform_apexSoap > $TMP_FILE
